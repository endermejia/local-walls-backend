...
export interface ApiAscentAscent extends Struct.CollectionTypeSchema {
...
export interface ApiBolterBolter extends Struct.CollectionTypeSchema {
...
export interface ApiCragCrag extends Struct.CollectionTypeSchema {
...
export interface ApiParkingParking extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    crag: Schema.Attribute.Relation<'manyToOne', 'api::crag.crag'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiRouteRoute extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ascents: Schema.Attribute.Relation<'oneToMany', 'api::ascent.ascent'>;
    bolters: Schema.Attribute.Relation<'manyToMany', 'api::bolter.bolter'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    name: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    topo_routes: Schema.Attribute.Relation<
      'oneToMany',
      'api::topo-route.topo-route'
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    url_8anu: Schema.Attribute.Text;
  };
}

export interface ApiTopoRouteTopoRoute extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    route: Schema.Attribute.Relation<'manyToOne', 'api::route.route'>;
    topo: Schema.Attribute.Relation<'manyToOne', 'api::topo.topo'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTopoTopo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::topo.topo'> &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiZoneZone extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    crags: Schema.Attribute.Relation<'oneToMany', 'api::crag.crag'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    likedCrags: Schema.Attribute.Relation<'oneToMany', 'api::crag.crag'>;
    likedRoutes: Schema.Attribute.Relation<'oneToMany', 'api::route.route'>;
    likedZones: Schema.Attribute.Relation<'oneToMany', 'api::zone.zone'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'plugin::users-permissions.user'
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::ascent.ascent': ApiAscentAscent;
      'api::bolter.bolter': ApiBolterBolter;
      'api::crag.crag': ApiCragCrag;
      'api::global.global': ApiGlobalGlobal;
      'api::parking.parking': ApiParkingParking;
      'api::route.route': ApiRouteRoute;
      'api::topo-route.topo-route': ApiTopoRouteTopoRoute;
      'api::topo.topo': ApiTopoTopo;
